...
This is not a complete list of all available key-bindings
and features. See /decide.el/ code for that.
|-----------------------------------------+-------------------------------+--------------------------------------|
| What to decide                          | Keys                          | Example Output                       |
|-----------------------------------------+-------------------------------+--------------------------------------|
| Answer yes or no question               | ? ?                           | -> YES                               |
| ... but more likely to be yes           | ? +                           | -> YES                               |
| ... but less likely to be yes           | ? -                           | -> NO                                |
| Roll 1d6                                | ? 6                           | [1d6] -> 3                           |
| Roll 2d6                                | ? D                           | [2d6] -> (5 1) = 6                   |
| Roll 1d20                               | ? 2 0                         | [1d20] -> = 20                       |
| Roll dice with modifier                 | ? d 2 d 6 + 1 RET             | [2d6+1] -> (5 3) +1 = 9              |
| Roll four FATE/Fudge dice               | ? F                           | [4dF] -> (- 0 + +) = 1               |
| Pick a number from a range              | ? r 1 - 1 0 RET               | [1-10] -> 5                          |
| ... make lower more likely              | ? r 1 < < 1 0 RET             | [1-10 (lowest of 2)] -> 4            |
| ... make lower numbers even more likely | ? r 1 < < < < 1 0 RET         | [1-10 (lowest of 4)] -> 1            |
| ... make higher numbers more likely     | ? r 1 > > > 1 0 RET           | [1-10 (highest of 3)]                |
| ... make edian numbers more likely      | ? r 1 - - - 1 0 RET           | [1-10 (average of 3)] -> 4           |
| Random compass direction (from 4)       | ? w 4                         | [(N,S,E,W)] -> N                     |
| Random compass direction (from 8)       | ? w 8                         | [(N,S,E,W,NE,NW,SE,SW)] -> NW        |
| Random relative direction               | ? W 4                         | [(forward,left,right,back)] -> right |
| Draw a card from included table         | ? t c a r d RET               | [<card>] -> 2 Clubs                  |
| Generate dragon(s) from example table   | ? t e x a m p l e - d TAB RET | [<example-dragon>] -> 3 ice dragons  |
| ... another one                         | ? t e x a m p l e - d TAB RET | [<example-dragon>] -> cute dragon    |
|-----------------------------------------+-------------------------------+--------------------------------------|
** Customizing Output
